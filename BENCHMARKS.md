...
| `codec_benchmark` | `edgefirst-codec` | JPEG/PNG decode into pre-allocated tensors vs. zune-jpeg/zune-png and image crate |
...
- **zune raw** — raw `zune-jpeg`/`zune-png` decode (allocates output buffer every call)
