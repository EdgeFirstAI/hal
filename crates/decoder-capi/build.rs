...
fn main() {
    ...
    cbindgen::Builder::new()
        ...
        .write_to_file(output_dir.join("decoder.h"));
    ...
    if target_os == "linux" {
        ...
        println!("cargo:rustc-cdylib-link-arg=-Wl,-soname,libedgefirst_decoder.so.{major}");
    }
    ...
    // function directly (the common case: a caller of ef_decoder_* functions
