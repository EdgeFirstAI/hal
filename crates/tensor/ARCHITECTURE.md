...
| [`tensor_dyn/`](https://github.com/EdgeFirstAI/hal/blob/main/crates/tensor/src/tensor_dyn/) | local | `TensorDyn` — dtype-erased tensor, image metadata (`PixelFormat`, row stride, plane offset, multi-plane composition) |
