...
mod edgefirst_hal {
    use super::*;
    use crate::{Result, TensorMapTrait, TensorMemory, TensorTrait};
    ...
    pub enum TensorMapT {
        TensorU8(crate::TensorMap<u8>),
        TensorI8(crate::TensorMap<i8>),
        TensorU16(crate::TensorMap<u16>),
        TensorI16(crate::TensorMap<i16>),
        TensorU32(crate::TensorMap<u32>),
        TensorI32(crate::TensorMap<i32>),
        TensorU64(crate::TensorMap<u64>),
        TensorI64(crate::TensorMap<i64>),
        TensorF32(crate::TensorMap<f32>),
        TensorF64(crate::TensorMap<f64>),
    }
    ...
    impl Tensor {
        ...
        fn __init__(
            ...
            let tensor = match dtype {
                "uint8" => TensorT::TensorU8(crate::Tensor::new(&shape, memory, name)?),
                "int8" => TensorT::TensorI8(crate::Tensor::new(&shape, memory, name)?),
                "uint16" => TensorT::TensorU16(crate::Tensor::new(&shape, memory, name)?),
                "int16" => TensorT::TensorI16(crate::Tensor::new(&shape, memory, name)?),
                "uint32" => TensorT::TensorU32(crate::Tensor::new(&shape, memory, name)?),
                "int32" => TensorT::TensorI32(crate::Tensor::new(&shape, memory, name)?),
                "uint64" => TensorT::TensorU64(crate::Tensor::new(&shape, memory, name)?),
                "int64" => TensorT::TensorI64(crate::Tensor::new(&shape, memory, name)?),
                "float32" => TensorT::TensorF32(crate::Tensor::new(&shape, memory, name)?),
                "float64" => TensorT::TensorF64(crate::Tensor::new(&shape, memory, name)?),
        ...
        fn reshape(&mut self, shape: Vec<usize>) -> PyResult<()> {
            self.0.reshape(&shape).map_err(|e| e.into())
        }
